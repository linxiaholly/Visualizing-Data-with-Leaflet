...
// Function to determine marker color based on magnitude of the earthquake 
...
legend.onAdd = function() {
  ...
  var colors = ['#ABEBC6','#2ECC71','#F1C40F','#F39C12','#D35400']
  var labels = [];


  // Add min & max
  var legendInfo = "<h3>Eathquake Magnitude</h3>" +
    "<div class=\"labels\">" +
